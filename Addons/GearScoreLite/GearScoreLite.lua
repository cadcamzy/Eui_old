...
--	end
	if Unit then
		if  ( UnitName("target") == Name or UnitName("mouseover") == Name or Unit:match("raid"))  and not ( GS_PlayerIsInCombat ) then 
			NotifyInspect("target"); NotifyInspect("mouseover"); MouseOverGearScore, MouseOverAverage = GearScore_GetScore(Name, Unit); 
		end
	else
		if  ( UnitName("target") == Name or UnitName("mouseover") == Name)  and not ( GS_PlayerIsInCombat ) then 
			NotifyInspect("target"); NotifyInspect("mouseover"); MouseOverGearScore, MouseOverAverage = GearScore_GetScore(Name, Unit); 
		end
	end
