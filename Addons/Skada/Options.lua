...
Skada.windowdefaults = {
	...
	barwidth=200,
	barorientation=1,
	barcolor = {r = 0.1, g = 0.1, b = 0.1, a=0.7},
	baraltcolor = {r = 0.45, g = 0.45, b = 0.8, a = 0.7},
	barslocked=true,

	classcolorbars = false,
	classcolortext = true,
	
	title = {menubutton = true, font="Accidental Presidency", fontsize=11,margin=0, texture="Armory", bordertexture="Armory", borderthickness=2, color = {r=0,g=0,b=0,a=0.6}},
	background = {margin=5, height=150, texture="None", bordertexture="None", borderthickness=8, color = {r=0.1,g=0.1,b=0.1,a=0.5}},
