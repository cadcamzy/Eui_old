...
local mod = Skada:NewModule(L["Healing and Absorbs"])
local spellsmod = Skada:NewModule(L["Healing and Absorbs spell list"])
local healedmod = Skada:NewModule(L["Healed and Absorbed players"])
