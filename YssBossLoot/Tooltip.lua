...
local r,g,b = .31, 1, .31 --modify by EUI
...
local function OnTooltipSetItem(tooltip, ...)
	...
	if link then
		...
		if stringCache[itemID] then
			...
			tooltip:AddDoubleLine(BB[boss] or " ", droprate,r,g,b,r,g,b)
		else
...
function YssBossLoot:EnableTooltipInfo()
	for _,tooltip in pairs{GameTooltip, ItemRefTooltip, ShoppingTooltip1, ShoppingTooltip2, GameTooltip ~= AtlasLootTooltip and AtlasLootTooltip or nil} do
		if tooltip then
