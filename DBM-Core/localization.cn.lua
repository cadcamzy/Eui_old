...
--	"/dbm version2: 进行团队范围的DBM版本检测并密语给那些使用过期版本的玩家（也可使用：ver2）",
	...
	"/dbm lockout: 向团队成员请求他们当前的团队副本锁定情况(锁定信息、副本id) (需开启团队广播及助理权限)。",
	"/dbm help：显示可用命令的说明。",
}
...
DBM_INSTANCE_INFO_STATUS_UPDATE		= "从%d个玩家获得反馈，来自%d个DBM用户：%d人发送了数据, %d人拒绝回传数据。继续为更多回复等待%d秒..."
...
DBM_INSTANCE_INFO_STATS_AWAY		= "离开: %s"
