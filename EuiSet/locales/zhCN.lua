...
if not L then return end
	...
	L["main_alpha"] = "启用透明背景"
	L["main_classcolortheme"] = "启用职业色主题"
	L["main_classcolorcustom"] = "自定职业色"

	--其它
	L["other_nameplate"] = "启用内置姓名板"
	L["other_nameplateauto"] = "战斗自动打开姓名板"
	L["other_nameplatevalue"] = "姓名板显示血量"
	L["other_mail"] = "启用内置邮件增强"
	L["other_cooldown"] = "启用冷却内置计时功能"
	L["other_tab"] = "启用专业标签"
	L["other_loot"] = "启用ROLL框增强"
	L["other_recipients"] = "启用收(发)件人列表"
	L["other_sr"] = "启用增强声望显示方式"
	L["other_focuser"] = "启用shift+左键设置焦点"
	L["other_ratings"] = "启用等级百分比转换"
	L["other_hb"] = "启用/hb 绑定快捷键功能"
	L["other_spellid"] = "启用鼠标提示显示技能ID"
	L["other_mbb"] = "启用小地图图标合集"
	L["other_minimap"] = "启用小地图"
	L["other_buff"] = "启用BUFF/DEBUFF美化"
	L["other_map"] = "启用大地图增强"
	L["other_mapscale"] = "大地图缩放比率"
	L["other_mapalpha"] = "大地图透明度(0~1)"
	L["other_raidcheck"] = "启用团队检查工具"
	L["other_xct"] = "启用内置xCT战斗信息显示"
	L["other_nameplatetank"] = "姓名版启用坦克模式"
	L["other_raidbuffreminder"] = "团队BUFF提醒"
	L["other_bossnotes"] = "启用BOSS一句话攻略"
	...
	L["unitframe_castbar"] = "启用施法条"
	L["unitframe_swing"] = "启用平砍计时条"
	L["unitframe_totdebuffs"] = "显示目标的目标的Debuff数"
	L["unitframe_colorClass"] = "启用血条职业色彩"
	L["unitframe_Fbuffs"] = "焦点BUFF数量"
	L["unitframe_Fdebuffs"] = "焦点DEBUFF数量"
	L["unitframe_portrait"] = "启用3D头像"
	...
	L["unitframe_cpoint"] = "启用连击点符文和图腾条"
	...
	L["unitframe_bigcastbar"] = "启用大型施法条"
	...
	L["raid_clickset"] = "启用点击施法,预设技能详见EuiUnitframe/ClickSets.lua"
	L["raid_hottime"] = "启用四角HOT计时数字"
	L["raid_hotsize"] = "四角HOT尺寸"
	L["raid_showPartyTarget"] = "显示队伍目标和宠物"
	L["raid_showParty"] = "显示小队框体"
	L["raid_boss"] = "显示BOSS"
	L["raid_mt"] = "显示MT"
	L["raid_raidtarget"] = "启用团队目标监视模块"
	L["raid_portrait"] = "小队/团队启用3D头像"
	L["raid_raidtool"] = "启用团队工具"
	...
	L["actionbar_rankwatch"] = "启用低级法术警报"
	
	-- 鼠标提示
	L["tooltip_enable"] = "启用鼠标提示"
	...
	L["tooltip_ShowIsPlayer"] = "是否在等级行显示“（玩家）”字样"
...
L["Clickset"] = "点击施法"
	...
	--皮肤
	L["skins_askins"] = "启用系统对话框美化"
	L["skins_dbm"] = "启用DBM皮肤"
	L["skins_skada"] = "启用Skada皮肤"
	L["skins_recount"] = "启用recount皮肤"
	L["skins_texture"] = "头像小队团队材质"
	L["skins_enable"] = "启用系统框体美化"
