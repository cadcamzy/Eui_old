...
if C["info"].apsp ~= 0 then
	...
	E.EuiCreatePanel(leftstat, E.Scale(1), E.Scale(1), "TOPLEFT", EuiMinimap, "BOTTOMLEFT", 0, C["other"].raidbuffreminder and -E.Scale(28) or -E.Scale(4))
	...
	function E.InfoapspPostion(frame)
		if E.Movers["Infoapsp"]["moved"] ~= true then
			...
			Infoapsp:SetPoint("TOPLEFT", EuiMinimap, "BOTTOMLEFT", 0, C["other"].raidbuffreminder and -E.Scale(28) or -E.Scale(4))
		end	
	end
...
if C["info"].dps ~= 0 then
	...
	E.EuiCreatePanel(rightstat, E.Scale(1), E.Scale(1), "TOPRIGHT", EuiMinimap, "BOTTOMRIGHT", 0, C["other"].raidbuffreminder and -E.Scale(28) or -E.Scale(4))
	...
	function E.InfodpsPostion(frame)
		if E.Movers["Infodps"]["moved"] ~= true then
			...
			Infodps:SetPoint("TOPRIGHT", EuiMinimap, "BOTTOMRIGHT", 0, C["other"].raidbuffreminder and -E.Scale(28) or -E.Scale(4))
		end	
	end
