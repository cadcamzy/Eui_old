...
for i = 1, NUM_CHAT_WINDOWS do
  ...
  if cf then 
    cf:SetFont(C["skins"].font, 12, "OUTLINE") 
    cf:SetFrameStrata("LOW")
    cf:SetFrameLevel(2)
  end
  local tab = _G['ChatFrame'..i..'Tab']
  if tab then
    tab:GetFontString():SetFont(C["skins"].font, 13, "OUTLINE")
...
if C["chat"].chatbar == true then
	...
	function cbar:Style()
		...
		stex = E.EuiSetFontn(s,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(w)
		...
		wtex = E.EuiSetFontn(w,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(g)
		...
		gtex = E.EuiSetFontn(g,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(o)
		...
		otex = E.EuiSetFontn(o,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(r)
		...
		rtex = E.EuiSetFontn(r,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(p)
		...
		ptex = E.EuiSetFontn(p,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(gt)
		...
		gttex = E.EuiSetFontn(gt,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(lgt)
		...
		lgttex = E.EuiSetFontn(lgt,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(yg)
		...
		ygtex = E.EuiSetFontn(yg,C["skins"].font,14)
	...
	--	E.EuiSetTemplate(y)
		...
		ytex = E.EuiSetFontn(y,C["skins"].font,14)
