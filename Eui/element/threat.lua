...
E.EuiCreatePanel(euithreatframe, 1, 1, "TOPLEFT", UIParent, "TOPLEFT", 10, -C["threat"].height - E.Scale(20))
...
function E.ThreatPoint(frame)
	if E.Movers["ThreatMover"]["moved"] ~= true then
		...
		ThreatMover:SetPoint("TOPLEFT", UIParent, "TOPLEFT", 10, -C["threat"].height - E.Scale(20))
	end	
end
