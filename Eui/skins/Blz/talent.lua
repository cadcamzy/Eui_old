...
local function LoadSkin()
	...
	PlayerTalentFrameToggleSummariesButton:SetPoint("BOTTOM", PlayerTalentFrame, "BOTTOM",0,5)
	...
	for i=1, 3 do
		...
		E.StripTextures(_G["PlayerTalentFramePanel"..i.."SelectTreeButton"],true)
	...
	E.EuiSetTemplate(PlayerTalentFrame,.7)
	E.EuiCreateBackdrop(PlayerTalentFramePanel1,.7)
	PlayerTalentFramePanel1.backdrop:SetPoint( "TOPLEFT", PlayerTalentFramePanel1, "TOPLEFT", 3, -3 )
	PlayerTalentFramePanel1.backdrop:SetPoint( "BOTTOMRIGHT", PlayerTalentFramePanel1, "BOTTOMRIGHT", -3, 3 )
	E.EuiCreateBackdrop(PlayerTalentFramePanel2,.7)
	PlayerTalentFramePanel2.backdrop:SetPoint( "TOPLEFT", PlayerTalentFramePanel2, "TOPLEFT", 3, -3 )
	PlayerTalentFramePanel2.backdrop:SetPoint( "BOTTOMRIGHT", PlayerTalentFramePanel2, "BOTTOMRIGHT", -3, 3 )
	E.EuiCreateBackdrop(PlayerTalentFramePanel3,.7)
	PlayerTalentFramePanel3.backdrop:SetPoint( "TOPLEFT", PlayerTalentFramePanel3, "TOPLEFT", 3, -3 )
	PlayerTalentFramePanel3.backdrop:SetPoint( "BOTTOMRIGHT", PlayerTalentFramePanel3, "BOTTOMRIGHT", -3, 3 )
	E.EuiCreateShadow(PlayerTalentFrame)
	...
	PlayerTalentFramePetModelRotateLeftButton:SetPoint("BOTTOM", PlayerTalentFramePetModel, "BOTTOM", -4, 4)
	PlayerTalentFramePetModelRotateRightButton:SetPoint("TOPLEFT", PlayerTalentFramePetModelRotateLeftButton, "TOPRIGHT", 4, 0)
	E.EuiCreateBackdrop(PlayerTalentFramePetPanel,.7)
	PlayerTalentFramePetPanel.backdrop:SetPoint( "TOPLEFT", PlayerTalentFramePetPanel, "TOPLEFT", 3, -3 )
	PlayerTalentFramePetPanel.backdrop:SetPoint( "BOTTOMRIGHT", PlayerTalentFramePetPanel, "BOTTOMRIGHT", -3, 3 )
	E.EuiCreateBackdrop(PlayerTalentFramePetModel,.7)
	PlayerTalentFramePetModel.backdrop:SetPoint( "TOPLEFT", PlayerTalentFramePetModel, "TOPLEFT")
	PlayerTalentFramePetModel.backdrop:SetPoint( "BOTTOMRIGHT", PlayerTalentFramePetModel, "BOTTOMRIGHT")
