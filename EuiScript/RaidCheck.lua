...
local function CheckRaidBuff()
	...
	local Group_NoBuff_Name = {
		...
		[L.RaidCheckBuffKings1] = {
			[L.RaidCheckDRUID]		= {["name"]="",["count"]=0,},
			[L.RaidCheckHUNTER]		= {["name"]="",["count"]=0,},
			[L.RaidCheckMAGE]		= {["name"]="",["count"]=0,},
			[L.RaidCheckPRIEST]		= {["name"]="",["count"]=0,},
			[L.RaidCheckROGUE]		= {["name"]="",["count"]=0,},
			[L.RaidCheckWARLOCK]		= {["name"]="",["count"]=0,},
			[L.RaidCheckWARRIOR]		= {["name"]="",["count"]=0,},
			[L.RaidCheckSHAMAN]		= {["name"]="",["count"]=0,},
			[L.RaidCheckPALADIN]		= {["name"]="",["count"]=0,},
			[L.RaidCheckDEATHKNIGHT]	= {["name"]="",["count"]=0,},
		},
